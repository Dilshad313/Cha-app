  ...
  return (
    ...
    >
      <div className="relative">
        ...
        />
        {isGroupChat && (
          <div className="absolute -bottom-1 -right-1 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full p-1 border-2 border-white dark:border-gray-900 shadow-md">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between mb-1">
          <div className="flex items-center gap-1.5 flex-1 min-w-0">
            ...
            {isGroupChat && (
              <span className="flex-shrink-0 text-xs font-semibold text-indigo-600 dark:text-indigo-400 bg-indigo-100 dark:bg-indigo-900/30 px-1.5 py-0.5 rounded">
                Group
              </span>
            )}
          </div>
